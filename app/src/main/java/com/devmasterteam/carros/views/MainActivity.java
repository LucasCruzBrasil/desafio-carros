...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * 1 - importar icone (background, padding, etc)
     * 2 - alterar manifest (incluir a propriedade que define qual será o logo)
     * 3 - alterar Activities (incluir chamadas para métodos que em tempo de execução alteram a AB)
     */
